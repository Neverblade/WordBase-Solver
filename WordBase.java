...
public class WordBase 
{
	...
	{	
		...
		//input the gameboard into an array using input.txt; there's a border around the regular gameboard
		...
		//input the gameboard point status into an array using input.txt (who owns what)
		f.readLine();
